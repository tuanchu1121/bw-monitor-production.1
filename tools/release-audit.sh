...
grep -q '^48.13.5-prod-r1-storage-root-bars$' VERSION || fail 'Root VERSION mismatch.'
grep -q '^48.13.5-prod-r1-storage-root-bars$' release/VERSION || fail 'Release VERSION mismatch.'
