...
grep -q '^48.13.5-prod-r2-vm-disk-panels$' VERSION || fail 'Root VERSION mismatch.'
grep -q '^48.13.5-prod-r2-vm-disk-panels$' release/VERSION || fail 'Release VERSION mismatch.'
