...
grep -q '^48.13.9-prod-r1-abuse-storage-cards$' VERSION || fail 'Root VERSION mismatch.'
grep -q '^48.13.9-prod-r1-abuse-storage-cards$' release/VERSION || fail 'Release VERSION mismatch.'
...
grep -q 'V48139_BUILD = "r1"' release/bw_monitor_app_v48_12_9_operations_ui.py || fail 'v48.13.9-r1 build missing.'
