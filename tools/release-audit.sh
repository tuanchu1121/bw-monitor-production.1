...
grep -q '^48.13.4-prod-r1-storage-precision$' VERSION || fail 'Root VERSION mismatch.'
grep -q '^48.13.4-prod-r1-storage-precision$' release/VERSION || fail 'Release VERSION mismatch.'
