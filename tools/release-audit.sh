...
grep -q '^48.13.8-prod-r1-storage-identity-bars$' VERSION || fail 'Root VERSION mismatch.'
grep -q '^48.13.8-prod-r1-storage-identity-bars$' release/VERSION || fail 'Release VERSION mismatch.'
