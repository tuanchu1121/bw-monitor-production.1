...
grep -q '^48.13.6-prod-r1-storage-grouped$' VERSION || fail 'Root VERSION mismatch.'
grep -q '^48.13.6-prod-r1-storage-grouped$' release/VERSION || fail 'Release VERSION mismatch.'
