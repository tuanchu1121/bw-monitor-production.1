...
Options:
  ...
  --release           Build archives and create/update tag/release v48.13.5-prod-r2
...
if ! git diff --cached --quiet; then
  git commit -m "BW Monitor v48.13.5-r2 VM-disk-panels production"
fi
