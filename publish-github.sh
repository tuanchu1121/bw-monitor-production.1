...
Options:
  ...
  --release           Build archives and create/update tag/release v48.13.5-prod-r1
...
if ! git diff --cached --quiet; then
  git commit -m "BW Monitor v48.13.5 storage-root-bars production"
fi
