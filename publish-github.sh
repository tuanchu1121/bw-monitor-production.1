...
Options:
  ...
  --release           Build archives and create/update tag/release v48.13.7-prod-r1
...
if ! git diff --cached --quiet; then
  git commit -m "BW Monitor v48.13.7-r1 retained-storage production"
fi
