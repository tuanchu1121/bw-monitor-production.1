...
Options:
  ...
  --release           Build archives and create/update tag/release v48.13.8-prod-r1
...
if ! git diff --cached --quiet; then
  git commit -m "BW Monitor v48.13.8-r1 Storage identity/bars production"
fi
