...
```text
checkout: /.data/agent
archive:  /root/bw-monitor-50.1.2-prod-r1-snapshot-time-fix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/bw-monitor-50.1.2-prod-r1-snapshot-time-fix-github-production.zip
REPO=/.data/agent
