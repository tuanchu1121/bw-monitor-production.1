...
```text
checkout: /.data/agent
archive:  /root/bw-monitor-50.3.0-prod-r1-bandwidth-consumption-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/bw-monitor-50.3.0-prod-r1-bandwidth-consumption-github-production.zip
REPO=/.data/agent
