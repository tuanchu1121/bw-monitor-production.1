...
```text
checkout: /.data/agent
archive:  /root/bw-monitor-50.2.2-prod-r1-original-time-restore-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/bw-monitor-50.2.2-prod-r1-original-time-restore-github-production.zip
REPO=/.data/agent
