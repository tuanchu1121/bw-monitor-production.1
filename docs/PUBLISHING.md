...
```text
checkout: /.data/agent
archive:  /root/bw-monitor-50.2.3-prod-r1-dashboard-snapshot-fix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/bw-monitor-50.2.3-prod-r1-dashboard-snapshot-fix-github-production.zip
REPO=/.data/agent
